...
echo  "$RC"
echo  "$RC"
echo  "$AZUL1 Este script convertirá tu SO Debian en una distribución dedicada"
echo  "$RC"
echo  "$AZUL1 a la obtención de información en fuentes abiertas, realizará las"
echo  "$RC"
echo  "$AZUL2 siguientes acciones:"
echo  "$RC"
echo  "$VERDE 1. Instalará las aplicaciones más utilizadas en OSINT para la recoleción"
echo  "$RC"
echo  "$VERDE de información en fuentes abiertas."
echo  "$RC"
echo  "$AZUL1 2. Personalizará el menú de escritorio para tener las aplicaciones accesibles"
echo  "$RC"
echo  "$AZUL1 por categorías."
echo  "$RC"
echo -n "$NARANJA [Pulsa intro para comenzar] ====>>>>>>>>"
read opc
echo -e "$RC"
